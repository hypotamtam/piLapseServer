...
import {convertToStreamConfig, mergeConfig, StreamConfig, StreamConfigKey} from "./LibcamConfig"
...
const configBodyValidations = checkSchema(Object.keys(StreamConfigKey)
                                                .reduce((schema, key) => {
...
app.post("/config", validate(configBodyValidations), (req: Request, res: Response) => {
